//=============================================================================
// Dwarf Rider Bone Crusher.
//=============================================================================
class DRBoneCrusher expands DwarfRider; 
...
function Died ( Pawn Killer , name DamageType , vector HitLoc )
{
	...
	assbag = Spawn(class'dwarfrider.DRBoneCrusher2', none,,loc);
...
function Texture PainSkin(int BodyPart)
{
	switch(BodyPart)
	{
		case BODYPART_HEAD:
			...
			SkelGroupSkins[12] = Texture'weapons.battlehammerBhammer'; //Dwarf weapon
			SkelGroupSkins[11] = Texture'creatures.Dwarfwd_Body'; // Dwarf Body
			SkelGroupSkins[14] = Texture'creatures.Dwarfwd_helmetb'; // Dwarf Helmet
...
defaultproperties
{
     ...
     SubstituteMesh=SkelModel'DwarfRider.DRBoneCrusher'
}
