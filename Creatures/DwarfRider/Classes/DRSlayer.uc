...
// Dwarf Rider Slayer.
//=============================================================================
class DRSlayer expands DwarfRider; 
...
function Died ( Pawn Killer , name DamageType , vector HitLoc )
{
	...
	assbag = Spawn(class'dwarfrider.DRSlayer2', none,,loc);
...
function Texture PainSkin(int BodyPart)
{
	switch(BodyPart)
	{
		case BODYPART_HEAD:
			...
			SkelGroupSkins[12] = Texture'weapons.sigurdaxesigurds_axe'; //Dwarf weapon
...
defaultproperties
{
     ...
     SubstituteMesh=SkelModel'DwarfRider.DRSlayer'
}
