...
// Dwarf Rider Soldier.
//=============================================================================
class DRSoldier expands DwarfRider; 
...
function Died ( Pawn Killer , name DamageType , vector HitLoc )
{
	...
	assbag = Spawn(class'dwarfrider.DRSoldier2', none,,loc);
...
function Texture PainSkin(int BodyPart)
{
	switch(BodyPart)
	{
		case BODYPART_HEAD:
			...
			SkelGroupSkins[15] = Texture'creatures.DwarfW_Leg'; // Dwarf Legs
			SkelGroupSkins[10] = Texture'weapons.TrialMacetrialpit_mace'; //Dwarf weapon
			SkelGroupSkins[12] = Texture'creatures.DwarfW_Body'; // Dwarf Body
			SkelGroupSkins[14] = Texture'creatures.DwarfW_Face'; // Dwarf Face
...
defaultproperties
{
     ...
     SubstituteMesh=SkelModel'DwarfRider.DRSoldier'
}
