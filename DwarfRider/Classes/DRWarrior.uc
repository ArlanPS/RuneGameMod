...
// Dwarf Rider Warrior.
//=============================================================================
class DRWarrior expands DwarfRider; 
...
function Died ( Pawn Killer , name DamageType , vector HitLoc )
{
	...
	assbag = Spawn(class'dwarfrider.DRWarrior2', none,,loc);
...
function Texture PainSkin(int BodyPart)
{
	switch(BodyPart)
	{
		case BODYPART_HEAD:
			...
			SkelGroupSkins[14] = Texture'creatures.DwarfW_Leg'; // Dwarf Legs
			SkelGroupSkins[11] = Texture'weapons.VikingAxeAxeskin'; //Dwarf weapon
			SkelGroupSkins[15] = Texture'creatures.DwarfW_Body'; // Dwarf Body
			SkelGroupSkins[10] = Texture'creatures.DwarfW_Face'; // Dwarf Face
			SkelGroupSkins[12] = Texture'weapons.WoodShielddwarf_wood_shield'; // Dwarf Shield
			SkelGroupSkins[13] = Texture'creatures.DwarfW_Arm'; // Dwarf Arms
			break;
		case BODYPART_TORSO:
		...
		case BODYPART_LLEG1:
			...
			break;
		case BODYPART_RLEG1:
			SkelGroupSkins[6] = Texture'creatures.snowbeasttp_armlegpain';
				break;
	}
	return None;
}
...
defaultproperties
{
     ...
     SubstituteMesh=SkelModel'DwarfRider.DRWarrior'
}
