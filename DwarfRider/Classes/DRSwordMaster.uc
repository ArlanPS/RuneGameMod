//=============================================================================
// Dwarf Rider SwordMaster
//=============================================================================
class DRSwordMaster expands DwarfRider; 
...
function Died ( Pawn Killer , name DamageType , vector HitLoc )
{
	...
	assbag = Spawn(class'dwarfrider.DRSwordMaster2', none,,loc);
...
function Texture PainSkin(int BodyPart)
{
	switch(BodyPart)
	{
		case BODYPART_HEAD:
			...
			SkelGroupSkins[12] = Texture'weapons.workswordDwarf_work_sword'; //Dwarf weapon
			SkelGroupSkins[11] = Texture'creatures.Dwarfwd_Body'; // Dwarf Body
			SkelGroupSkins[13] = Texture'creatures.Dwarfwd_helmeta'; // Dwarf Helmet
...
defaultproperties
{
     ...
     SubstituteMesh=SkelModel'DwarfRider.DRSwordMaster'
}
