//=============================================================================
// Dwarf Rider BoneBreaker.
//=============================================================================
class DRBoneBreaker expands DwarfRider; 
...
function Died ( Pawn Killer , name DamageType , vector HitLoc )
{
	...
	assbag = Spawn(class'dwarfrider.DRBoneBreaker2', none,,loc);
...
function Texture PainSkin(int BodyPart)
{
	switch(BodyPart)
	{
		case BODYPART_HEAD:
			...
			SkelGroupSkins[14] = Texture'creatures.Dwarfwd_armleg'; // Dwarf Arms Legs
			SkelGroupSkins[13] = Texture'weapons.WorkHammerd_work_hammer'; //Dwarf weapon
			SkelGroupSkins[12] = Texture'creatures.Dwarfwd_Body'; // Dwarf Body
			SkelGroupSkins[11] = Texture'creatures.Dwarfwd_helmeta'; // Dwarf Helmet
...
defaultproperties
{
     ...
     SubstituteMesh=SkelModel'DwarfRider.DRBoneBreaker'
}
